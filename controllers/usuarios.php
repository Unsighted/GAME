...
class GestorUsuariosController{
	...
	static public function guardarPuntajesController($datos){
		...
		$respuesta = GestorUsuariosModel::guardarPuntajesModel($datosController, "usuariosdb");

		if($respuesta == "ok"){

			$respuesta1 = GestorUsuariosModel::seleccionarPuntajeModel($datosController, "usuariosdb");
