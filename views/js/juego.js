...
var juego = {
	...
	tiempo: function(){
		...
		=============================================*/
		 ...
		 //if(datos.nivel == 1){datos.sBackground01.play(); }
		...
		if(datos.movTrampas >= 200){datos.cambioMovTrampas = true}
		...
		/*=============================================
		MOVIMIENTO HORIZONTAL LANZAS
		=============================================*/	

		for(var i = 0; i < datos.posEnemigos2.length; i++){

			datos.posEnemigos2[i].x += datos.movimiento;
		}
