...
<div id="inicio">
	...
	<div id="cerrarSesion" onclick="inicio.cerrarFacebook()"><a href="salir" style="text-decoration:none; color:rgb(224, 88, 52);">Cerrar Sesión</a></div>

	<h2 id="saludo">¡Hola <?php echo $_SESSION["primer_nombre"];
								echo '<img style="border-radius:100%; margin-left:10px" width="60px" src="'.$_SESSION["foto"].'">'
									 ?>  bienvenid@!</h2>
...
<audio src="views/mp3/background01x.mp3" id="sBackground01" type="audio/mpeg" muted></audio>
